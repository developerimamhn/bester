...
import hero_bg_img from "../../assets/image/hero_bg_img.png";
...
const HeroSection = () => {
    return (
        <div className='hero-section relative w-full h-auto flex flex-col items-center pt-[30px] sm:pt-[70px] md:pt-[90px] lg:pt-[120px] xl:pt-[130px]'>
            <img src={hero_bg_img} alt="bg" className='hero-bg absolute inset-0 w-full h-full object-cover rounded-b-3xl z-0' />
            ...
            <div className='relative flex flex-col items-center justify-center pt-30'>
                <div className='rounded-[80px] border border-[#FFFFFF14] z-5 py-1 px-2 sm:px-3 md:px-4 mb-1 sm:mb-2 bg-[linear-gradient(90.8deg,rgba(255,255,255,0.08)_15.13%,rgba(255,255,255,0)_50.66%,rgba(255,255,255,0.08)_85.52%)]'>
                ...
                <div className='flex flex-col items-center justify-center z-1 gap-3 sm:gap-4 md:gap-5 lg:gap-6'>
                    <h1 className='hero-heading flex items-center justify-center font-semibold heading_text leading-[120%] bg-[linear-gradient(90deg,rgba(255,255,255,0)_-67.03%,#FFFFFF_46.74%,rgba(255,255,255,0)_167.28%)] bg-clip-text text-transparent '>
                        Precision Crash Predictions
                    </h1>
                    <p className='hero-copy font-normal prg_text leading-[150%] tracking-[0%] text-center text-[#EFEDFDB2]'>
                    ...
                    <div className='rounded-2xl border border-[#FFFFFF] p-1 sm:p-1.5 md:p-2 bg-[#FFFFFF66]'>
                        <button className='hero-cta relative z-5 rounded-xl py-2 pr-2 bg-[#3B42E8] shadow-[0px_3.71px_4.85px_0px_#3B42E827,0px_10.27px_13.4px_0px_#3B42E838,0px_24.72px_32.26px_0px_#3B42E830,0px_42px_107px_0px_#3B42E857,inset_0px_1px_4px_2px_#DFE0FF,inset_0px_1px_18px_2px_#CFD1FF] cursor-pointer'>
                            ...
                            <span className='flex items-center justify-center'>
                                <span className='relative z-5 flex items-center justify-center px-2.5 sm:px-4 md:px-5 lg:px-6 font-medium prg_text leading-[150%] capitalize text-[#FFFFFF]'>
                                    Download Now
                                </span>
            ...
            <div className="hero-stats z-5 relative grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-10 lg:gap-16 pt-20 sm:pt-40 md:pt-45 lg:pt-50 xl:pt-60 2xl:pt-60 pb-24 sm:pb-26 md:pb-30 lg:pb-34 xl:pb-38 2xl:pb-45">
                {stats.map((item) => (
                    <div key={item.id} className="hero-stat-card flex gap-4">
