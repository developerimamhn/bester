...
const Footer = () => {
    return (
        <div className='relative bg-[#000002]'>
            <img src={footer_bg} alt=" bg" className='absolute inset-0 w-full h-full object-cover z-0' />
            <div className='relative container mx-auto px-4 w-full h-auto'>
                        ...
                        <div key={index} className='flex flex-col justify-between wallet-card'>
                            ...
                            <div className='wallet-address-box'>
                                ...
                                <div className='flex items-center justify-center wallet-copy-btn'>
                                    <img src={copy} alt="icon" className='wallet-copy-icon' />
                                </div>
                            </div>
                        </div>
                    ))}
